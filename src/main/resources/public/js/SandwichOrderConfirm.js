...
class SandwichOrderConfirm extends MyCustomElement{
  ...
  orderTemplate(order){
      return `
            ...
            <div>
                <p>Rating geven:</p>
                <a onclick="saveRating(1, order)" class="btn btn-warning rating">1</a>
                <a onclick="saveRating(2, order)" class="btn btn-warning rating">2</a>
                <a onclick="saveRating(3, order)" class="btn btn-warning rating">3</a>
                <a onclick="saveRating(4, order)" class="btn btn-warning rating">4</a>
                <a onclick="saveRating(5, order)" class="btn btn-warning rating">5</a>
                </br></br>
